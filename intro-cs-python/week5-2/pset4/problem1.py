...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        shift_lowercase_values = lowercase_values[shift:] + lowercase_values[:shift]
        
        uppercase = list(string.ascii_uppercase)                 
        uppercase_values = list(string.ascii_uppercase)
        shift_uppercase_values = uppercase_values[shift:] + uppercase_values[:shift]

        original_values = lowercase + uppercase
        new_value = shift_lowercase_values + shift_uppercase_values

        self.shift_dict = dict(zip(original_values, new_value))
    ...
    def apply_shift(self, shift):
        ...
        for i in self.message_text:
            if i not in self.build_shift_dict(shift).keys():
                ...
                encrypted_msg.append(self.build_shift_dict(shift)[i])
